...
export const NOTIFICATIONS_CATALOG: NotificationCatalogEntry[] = [
  ...
  // ============ ENGAJAMENTO ============
  {
    ...
    nome: "Biscoito recebido",
    descricao: "Notifica o destinatário quando alguém envia um shout-out. Opcionalmente também posta no canal escolhido.",
    categoria: "Engajamento",
    gatilho: { tipo: "evento", detalhe: "Envio de biscoito (app ou modal Slack)" },
    publico: ["Destinatário do biscoito", "Canal público (opcional)"],
  ...
  },
  {
    ...
    nome: "Biscoito visível para gestores",
    descricao: "Avisa gestor direto e diretores da área quando um membro do time recebe um biscoito.",
    categoria: "Engajamento",
    gatilho: { tipo: "evento", detalhe: "Após inserção do biscoito (fire-and-forget)" },
    publico: ["Gestor direto", "Diretor"],
    canais: ["slack_dm"],
  ...
  },
  {
    ...
    descricao: "Resumo do mês anterior de biscoitos, ranking e destaques por sub-time.",
    categoria: "Engajamento",
  ...
  },
  {
    ...
    descricao: "Abre o modal de envio de biscoito direto do Slack via comando slash.",
    categoria: "Engajamento",
