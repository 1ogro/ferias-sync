-- Segregar papéis organizacionais de permissões administrativas

-- Primeiro, vamos adicionar a nova coluna is_admin
ALTER TABLE public.people 
ADD COLUMN is_admin boolean DEFAULT false;

-- Renomear a coluna papel para organizational_role 
ALTER TABLE public.people 
...
-- Remover constraint padrão antigo e definir novo padrão para organizational_role
ALTER TABLE public.people 
...
-- Atualizar políticas RLS para requests (baseadas em organizational_role)
...
-- Inserir exemplo de admin puro (sem papel organizacional)
-- Este comando é apenas ilustrativo e pode ser removido se não desejado
-- INSERT INTO public.people (id, nome, email, is_admin, organizational_role, ativo) 
-- VALUES ('admin-system', 'Administrador Sistema', 'admin@empresa.com', true, NULL, true);